...
_C.TRAIN.EFFICIENCY_WEIGHT = 1.0
_C.TRAIN.TOKENS_EFFICIENCY_TARGET = 0.5
_C.TRAIN.BLOCKS_EFFICIENCY_TARGET = 0.9
_C.TRAIN.PERTASK_OVERLAP_WEIGHT = 0.0
_C.TRAIN.ADAPTIVE = False
_C.TRAIN.ADA_BLOCKS = False
_C.TRAIN.ADA_TOKENS = False
_C.TRAIN.HARD_GUMBEL = True
_C.TRAIN.POLICY = 'single'
_C.TRAIN.TRAIN_MODE = 'default'
_C.TRAIN.TASK_EPOCHS = 200
_C.TRAIN.ALTERNATING_TASK_TRAINING = False
_C.TRAIN.USE_SINGLE_TASK_LOSS = True
_C.TRAIN.COMBINED_FINE_TUNE = True
_C.TRAIN.CONTROLLER_MODE = 'per_model'
_C.TRAIN.KD_LOSS_WEIGHT = 0.1
_C.TRAIN.BLOCK_CONTROLLER_DIM = 100
_C.TRAIN.TOKEN_CONTROLLER_DIM = 100
_C.TRAIN.TASK_ATTENTION = False
_C.TRAIN.TASK_ATTENTION_NUM_HEADS = 5
_C.TRAIN.PER_LAYER_EFFICIENCY_LOSS = False
_C.TRAIN.MIXED_PER_LAYER_EFFICIENCY_LOSS = False
_C.TRAIN.WEIGHTED_TOKENS_LOSS = False
...
def update_config(config, args):
    ...
    if _check_args('blocks_efficiency_target'):
        config.TRAIN.BLOCKS_EFFICIENCY_TARGET = args.blocks_efficiency_target

    if _check_args('tokens_efficiency_target'):
        config.TRAIN.TOKENS_EFFICIENCY_TARGET = args.tokens_efficiency_target

    if _check_args('efficiency_weight'):
        config.TRAIN.EFFICIENCY_WEIGHT = args.efficiency_weight

    if _check_args('pertask_overlap_weight'):
        config.TRAIN.PERTASK_OVERLAP_WEIGHT = args.pertask_overlap_weight
